...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        movie1 = Movie.objects.get(title="El señor de los anillos: El retorno del rey")
        movie2 = Movie.objects.get(title="El señor de los anillos: Las dos torres")
        ...
        prompt = "película sobre el señor de los anillos y la lucha contra el mal"
